...
class state_estimator_lcmt(object):
    ...
    __slots__ = ["rpy", "omegaBody", "aBody", "p", "vWorld", "vBody", "omegaWorld", "quat", "contact_estimate", "aWorld", "timestamp_us"]

    __typenames__ = ["float", "float", "float", "float", "float", "float", "float", "float", "float", "float", "int64_t"]
